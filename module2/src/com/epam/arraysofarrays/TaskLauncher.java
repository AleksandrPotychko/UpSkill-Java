...
public class TaskLauncher {
    ...
    //   System.out.println(Arrays.deepToString(MatrixWorkerOrderN.createSquareMatrixOrderPositiveN(MATRIX_ORDER)));
     ...
     //   System.out.println(MatrixWorkerOrderN.createSquareMatrixAndCalculatePositiveElements(MATRIX_ORDER));
        ...
        //task 8
     //   MatrixWorker.swapTwoAnyColumns(MatrixInitializer.positiveSquareMatrix);

        //task 9
       // System.out.println(MatrixWorker.calculateColumnWithLargestSum(MatrixInitializer.positiveSquareMatrix));

        //task 10
        MatrixWorker.calculatePositiveElementsOfMainDiagonal(MatrixInitializer.positiveAndNegativeNumbersMatrix);
    }
}