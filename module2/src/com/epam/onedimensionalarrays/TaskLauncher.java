...
public class TaskLauncher {
    public static void main(String[] args) {
        ...
        String arrayCharacteristic = Arrays.toString(RealNumbersArrayAnalyser.characterizeArray(arrayNaturalNumbers));System.out.println(arrayCharacteristic);
        NumbersGreaterTheirIndex number = new NumbersGreaterTheirIndex();number.numbersGreaterTheirIndex(arrayNaturalNumbers);
        ...
        System.out.println(MostRecurringNumber.getMostPopularNumber(arrayNaturalNumbers));
    }
}