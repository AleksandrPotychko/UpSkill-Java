...
public class TaskLauncher {
    ...
    private final static String INFORMATICS = "informatica";
    ...
    public static void main(String[] args) {
        ...
        //task 4
        System.out.println(StringWorker.convertInformaticaToTort(INFORMATICS));

        //task 5
        System.out.println(StringWorker.calculateTheA(TEXT_FOR_THE_TASK, LETTER_A));

        //task 6
        System.out.println(StringWorker.repeatEveryCharacterTwice(INFORMATICS));
        ...
        //task 9
        System.out.println(Arrays.toString(StringWorker.calculateLowerAndUpperCase(TEXT_FOR_THE_TASK)));
